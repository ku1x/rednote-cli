...
from rednote_cli.cookies import cache_note_context, get_cached_note_context
from rednote_cli.exceptions import UnsupportedOperationError, XhsApiError
...
class TestReadingEndpointBehavior:
    ...
    def test_search_notes_uses_browser_like_prewarm_sequence(self, monkeypatch):
        ...
        monkeypatch.setattr("rednote_cli.client_mixins._SEARCH_SESSION_CACHE", OrderedDict())
        monkeypatch.setattr("rednote_cli.client_mixins._SEARCH_SESSION_CACHE_LOADED", True)
    ...
    def test_search_notes_reuses_search_id_after_cache_reload(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("rednote_cli.client_mixins.get_config_dir", lambda: tmp_path)
        monkeypatch.setattr("rednote_cli.client_mixins._SEARCH_SESSION_CACHE", OrderedDict())
        monkeypatch.setattr("rednote_cli.client_mixins._SEARCH_SESSION_CACHE_LOADED", False)
        monkeypatch.setattr("rednote_cli.client_mixins._SEARCH_SESSION_CACHE_PATH", None)
